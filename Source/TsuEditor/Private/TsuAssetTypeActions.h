...
public:
	...
	void OpenAssetEditor(const TArray<UObject*>& Objects, TSharedPtr<IToolkitHost> EditWithinLevelEditor = TSharedPtr<IToolkitHost>()) override;
	void AssetsActivated(const TArray<UObject*>& Objects, EAssetTypeActivationMethod::Type ActivationType) override;
	bool CanLocalize() const override;
	bool CanMerge() const override;
	void Merge(UObject* Object) override;
