...
public:
	...
	/** */
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Meta=(TsuStaticExtension="Transform"))
	 ...
	 */
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, BlueprintInternalUseOnly, Meta=(TsuExtension, DisplayName="Contains NaN"))
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Meta=(TsuConstant="Transform"))
