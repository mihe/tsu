...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Meta=(TsuStaticExtension="Vector"))
	...
	/** A zero vector (0,0,0) */
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Meta=(TsuConstant="Vector"))
	static FVector Zero()
	{
